...
const ContactPage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    window.open(`https://wa.me/8610822657?text=${whatsappMessage}`, '_blank');
  };
                ...
                <div className={contactStyles.contactInfo}>
                  ...
                  <div className={contactStyles.contactItem}>
                    ...
                    <div>
                      ...
                      <p className={contactStyles.contactDetail}>123 Cinema Street, Film City, Tamilnadu, FC 600001</p>
